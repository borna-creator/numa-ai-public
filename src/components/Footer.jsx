...
const socialLinks = [
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/numaiq/',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/numaiq/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/numa.iq/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <Link to="/" className="shrink-0">
              <LogoWide className="h-10 w-auto" />
            </Link>
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl border border-slate-200 flex items-center justify-center text-slate-400 hover:text-numa-600 hover:border-numa-200 hover:bg-numa-50 transition-all"
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-slate-100 text-sm text-slate-500">
            <p>&copy; {new Date().getFullYear()} NumaIQ. All rights reserved.</p>
            <div className="flex items-center gap-6">
              <Link to="/privacy" className="hover:text-numa-600 transition-colors">Privacy Policy</Link>
              <Link to="/terms" className="hover:text-numa-600 transition-colors">Terms &amp; Conditions</Link>
            </div>
          </div>
        </div>
      </div>
